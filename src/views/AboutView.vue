      ...
      <div class="flex flex-wrap px-8">
        ...
        <div class="flex items-center text-center">
          ...
          <a
            ...
            target="_blank"
            class="w-9 h-9 mr-1 rounded-full flex justify-center items-center border border-gray-300
            hover:border-red-400 hover:bg-red-400 hover:text-white text-red-400"
          >
            <svg
              role="img"
              width="20"
