...
<div class="container mt-24">
  <div class="flex flex-wrap place-content-center">
        <div class="text-center text-primary w-1/2 px-4">
    ...
    <div class="bg-red-400 p-6 rounded-lg shadow-lg">
      <div class="flex flex-wrap conten items-center text-center">
        <h2 class="text-white text-lg mr-4">Follow our Socmed</h2>
          <!-- youtube -->
        <a
          href="https://www.youtube.com/channel/UCROgvoq2wOIPapoM4G64nQQ/about"
          target="_blank"
          class="w-9 h-9 mr-1 rounded-full flex justify-center items-center border-red-400
          text-white">
        <svg
          role="img"
          width="20"
        ...
        <path
          ...
          6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505
          9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24
          12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg></a>

          <!-- Instagram -->
          <a
            href="https://www.instagram.com/lutfialdrii/"
            target="_blank"
            class="w-9 h-9 mr-1 rounded-full flex justify-center items-center border-red-400
            text-white">
          ...
          <!-- Linkedin -->
          <a
            href="https://www.linkedin.com/in/lutfi-aldri-permana-851810152/"
            target="_blank"
            class="w-9 h-9 mr-1 rounded-full flex justify-center items-center border-red-400
            text-white">
          ...
          <!-- Github -->
          <a
            href="https://github.com/lutfialdrii"
            target="_blank"
            class="w-9 h-9 mr-1 rounded-full flex justify-center items-center border-red-400
            text-white">
          ...
          <!-- Facebook -->
          <a
            href="https://www.facebook.com/profile.php?id=100004212375955"
            target="_blank"
            class="w-9 h-9 mr-1 rounded-full flex justify-center items-center border-red-400
            text-white">
